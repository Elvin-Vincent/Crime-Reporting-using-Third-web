  ...
  return (
    <div>
      <div className="flex justify-between items-center h-full py-5 uppercase ">
        <h1 className="text-4xl font-bold ml-6 text-neutral-600 cursor-pointer  tracking-wider transform hover:scale-95 hover:bg-opacity-50 transition ease-in duration-200">
          Safe Whistle
        </h1>
